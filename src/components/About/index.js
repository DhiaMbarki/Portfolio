      ...
      <div className="container about-page">
        <div className="text-zone">
         ...
         Working on databases, back-end logic, application programming interface (APIs), Data Structures and Algorithms, using <spam className='color'>Node.js</spam>  <br/>
          ...
          <h3>
Visit my <a className='color' href="https://www.linkedin.com/in/dhia-mbarki-331270209/">LinkedIn</a>   profile for more details.Also you can checkout my <a className='color'>cv</a> on this <a className='color' href="">Link</a>    
